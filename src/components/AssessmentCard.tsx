  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
      <div className="mb-6 flex flex-col items-center gap-4">
        <h3 className="text-center text-gray-900">{assessment.app_name}</h3>
      ...
      <div className="space-y-4">
        <div>
          <h4 className="mb-2 text-sm text-gray-700">Security Controls</h4>
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-lg bg-gray-50 px-3 py-2">
              <span className="text-sm text-gray-700">RBAC</span>
        ...
        <div>
          <h4 className="mb-2 text-sm text-gray-700">Score Breakdown</h4>
